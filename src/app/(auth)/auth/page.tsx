...
const Auth = () => {
    return (
        <main className='authOverlay h-full w-full flex justify-center items-center'>
            <div className="actions w-full h-full p-6 bg-gradient-to-t via-bg-primary via-50% from-bg-primary to-bg-highlight/25 flex flex-col gap-4 justify-around  items-center">
